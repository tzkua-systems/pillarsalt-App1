...
{
    public partial class Arduino1 : Form
    {
        string serialDataIn;
        ...
        private void Arduino1_Load(object sender, EventArgs e)
        {
        ...
        private void Arduino1_FormClosing(object sender, FormClosingEventArgs e)
        {
            if(serialPort1.IsOpen)
            {
                try
